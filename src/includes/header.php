    ...
    <div id="header-menu" class="w-8/12">
      <div class="xl:flex hidden justify-end xl:flex-wrap flex-auto leading-none  pb-5">
        <div class="px-5 hover:text-grey-700 group relative pb-5 transition-all">
          <a href="about.php" class="my-6 tracking-wider font-cursive text-lg text-cyan-600 hover:text-cyan-800">
            About
            <ul class="hidden group-hover:block absolute bg-cyan-600 top-10 w-60 filter drop-shadow-lg backdrop-blur">
              <li><a href="about.php" class="transition-all tracking-wider text-lg text-cyan-600 bg-gray-300 hover:bg-white hover:text-cyan-800 p-3 block filter drop-shadow-lg">About Us</a></li>
      ...
      <div x-data="{ open: false }" class="xl:hidden block text-none leading-none">
        ...
        <div x-show="open" x-transition @click.away="open = false" class="absolute w-full left-0 top-[140px] z-50">
          <div class="container md:block justify-center text-center 2xl:flex-wrap leading-none text-gray-500 text-base py-5 bg-gray-700">
            ...
            <div class="py-3 text-white hover:opacity-70"><a href="about.php" class="my-6 tracking-wider">About</a></div>
